            ...
            <div className="card scroll h-100">
                ...
                <div className="card-body">
                    ...
                    <DropdownButton className="align-self-end" drop="up" variant="primary" size="sm" color="link" id="dropdown-basic-button" title="">
                        <Dropdown.Item disabled={!(this.props.userIDState === this.props.userIDItem || this.props.isAdmin)} onClick={() => { if (window.confirm("Are you sure you wish to delete this trail?")) this.props.removeItem(this.props.itemID, this.props.userIDItem, this.props.fileName) }}>Remove Item</Dropdown.Item>
